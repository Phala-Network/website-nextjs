        ...
        <div className="grid gap-9 lg:grid-cols-2">
          <div className="flex flex-col gap-5">
            ...
            <p className="text-lg text-muted-foreground">
              Deploy confidential AI with confidence. Our platform is SOC 2 Type I certified and HIPAA compliant,
              with ISO 27001 certification in progress. Hardware-backed security meets regulatory requirements.
            </p>
            <div className="mt-4 flex flex-wrap items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-muted-foreground">ISO 27001</span>
              </div>
            </div>
            <div className="mt-2">
          ...
          <div className="rounded-2xl border border-border bg-background">
            <div className="relative overflow-hidden border-b border-border p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="mt-2 w-3/4 pr-10 text-sm text-muted-foreground md:text-base">
                  Independent audit validates our security, availability, and confidentiality controls.
                  Download the full report from our Trust Center.
                </p>
              </div>
              <img
                src="/trust/soc2.png"
            ...
            <div className="relative overflow-hidden p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="mt-2 w-3/4 pr-10 text-sm text-muted-foreground md:text-base">
                  Healthcare-ready infrastructure with protected health information (PHI) safeguards
            ...
            <div className="relative overflow-hidden border-t border-border p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="mt-2 w-3/4 pr-10 text-sm text-muted-foreground md:text-base">
                  Working toward international information security management certification
                  to meet global enterprise requirements.
                </p>
              </div>
              <img
