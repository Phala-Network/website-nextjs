      ...
      <article className="h-full flex flex-col gap-4">
        <div className="rounded-[6px] overflow-hidden aspect-390/220">
          <img
            src={
              post.cover
                ? `https://img0.phala.world/cover/780x440/${post.id.replace(/-/g, '')}.jpg`
        ...
        <div className="grow flex flex-col justify-between gap-y-2 px-6">
          <h3 className="text-[18px] font-bold tracking-tight leading-6 line-clamp-3 mb-4">
              ...
              <>
                ...
                <div className="flex items-center gap-3 py-2">
                  {post.authors[0].avatar ? (
                    ...
                    <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-[24px] font-light">
                      {getInitial(post.authors[0].nickname)}
                    </div>
                  )}
                  <div className="flex flex-col gap-y-0.5">
                    <span className="text-[16px] font-medium">
                      {post.authors[0].nickname}
                    </span>
