      ...
      <div className="container grid h-full w-full grid-cols-1 gap-12 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-6 leading-relaxed md:max-w-lg">
            TEEs with Intel TDX and AMD SEV provide CPU-level memory encryption—your
            AI models, datasets, and computations stay encrypted in-use. Not even
            cloud admins or hypervisors can inspect runtime state. Remote attestation
            proves the enclave is genuine before you send data.
          </p>
          <p className="text-muted-foreground mt-4 leading-relaxed md:max-w-lg">
            Built on zero-trust principles, our confidential computing infrastructure
            ensures data remains encrypted throughout the entire computation lifecycle.
            Hardware root-of-trust, sealed storage, and cryptographic proofs provide
            verifiable protection against insider threats and infrastructure compromise.
          </p>
