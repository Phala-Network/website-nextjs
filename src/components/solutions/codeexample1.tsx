...
const Codeexample1 = () => {
  const codeExample = `# Verify attestation quote
        ...
        <div className="grid place-items-center gap-10 lg:grid-cols-2 lg:gap-0">
          <div className="flex flex-col gap-6 lg:pr-20">
            ...
            <p className="text-muted-foreground md:text-lg">
              Get shareable Intel DCAP quotes verified with Phala Cloud's API.
              Hardware attestation ensures your code runs in genuine TEE hardware.
            </p>
          ...
          <div className="flex w-full flex-col gap-1 overflow-hidden">
            <div className="rounded-lg overflow-hidden bg-[#1e1e1e] border border-neutral-800">
              <div className="flex items-center justify-between border-b border-neutral-800 px-4 py-2 bg-[#252525]">
                <span className="text-sm text-neutral-400">verify-quote.sh</span>
              </div>
              <SyntaxHighlighter
                language="bash"
                style={oneDark}
