...
export const Roadmap = () => {
  ...
  return (
    <div className="relative">
      ...
      <main className={cn("safe-viewport", "grid grid-cols-1 xl:grid-cols-20 3xl:grid-cols-24", "relative overflow-hidden py-24")}>
        <article className={cn("cols-span-1 xl:col-start-2 xl:col-span-18 3xl:col-start-6 3xl:col-span-14 py-4")} ref={ref}>
          <RoadmapSvg />
        </article>
