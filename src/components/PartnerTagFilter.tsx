...
export default function PartnerTagFilter({ 
  ...
  const displayTags = isExpanded ? allTags : priorityTags.filter(tag => allTags.includes(tag))
    ...
    <div className="flex flex-col gap-4 mb-8 text-center">
      ...
      <div className="flex flex-wrap gap-2 justify-center">
          ...
          <button
            ...
            className={cn(
              ...
              selectedTags.includes(tag)
                ...
                : "bg-white text-black-800 border-gray-300 hover:border-green-500 hover:bg-green-50"
            )}
          >
            {tag}
          </button>
        ...
        {!isExpanded && otherTags.some(tag => allTags.includes(tag)) && (
          ...
          >
            + More tags ({otherTags.filter(tag => allTags.includes(tag)).length})
          </button>
        )}
