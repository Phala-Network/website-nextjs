...
const GpuTeeHero = () => {
  const images = [
    {
      src: '/images/gpu-h200.jpg',
      alt: 'NVIDIA H200 GPU',
      name: 'H200',
    },
    {
      src: '/images/gpu-h100.jpg',
      alt: 'NVIDIA H100 GPU',
      name: 'H100',
    },
    {
      src: '/images/gpu-security.jpg',
      alt: 'TEE Security Architecture',
      name: 'TEE Security',
    },
  ]
      ...
      <div className="container">
        <div className="mx-auto flex max-w-2xl flex-col items-center justify-center gap-4">
          ...
          <p className="px-10 text-center text-muted-foreground lg:text-lg">
            Run NVIDIA H200/H100 workloads with complete hardware protection.
            The only cloud combining Intel TDX + NVIDIA Confidential Computing
        ...
        <div className="relative mt-4">
          <div className="relative z-10 mx-auto my-7 flex w-fit cursor-pointer items-center justify-center gap-8 rounded-full bg-muted px-4 py-2 md:my-0 lg:translate-y-12 lg:py-3 xl:px-8 xl:py-4">
            <div className="flex items-center gap-2">
              <Gpu className="size-4 opacity-60 lg:size-6" />
              <span className="text-xs font-medium lg:text-sm">
                H200 / H100 / B200
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Cpu className="size-4 opacity-60 lg:size-6" />
              <span className="text-xs font-medium lg:text-sm">Intel TDX</span>
            </div>
            <div className="flex items-center gap-2">
              <Shield className="size-4 opacity-60 lg:size-6" />
              <span className="text-xs font-medium lg:text-sm">
                Dual Attestation
              </span>
            </div>
