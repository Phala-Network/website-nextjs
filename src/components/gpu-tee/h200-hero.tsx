        ...
        <div className="flex flex-col items-center text-center lg:max-w-3xl lg:items-start lg:text-left">
          ...
          <div className="mb-8 grid grid-cols-2 gap-4 w-full max-w-xl">
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">141GB</div>
              <div className="text-sm text-muted-foreground">HBM3e Memory</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">4.8 TB/s</div>
              <div className="text-sm text-muted-foreground">Bandwidth</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">2x Faster</div>
              <div className="text-sm text-muted-foreground">vs H100</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
          ...
          <div className="mt-6 text-sm text-muted-foreground">
            Starting at{' '}
            <span className="font-bold text-foreground">$3.50/GPU/hr</span>{' '}
            on-demand or{' '}
            <span className="font-bold text-foreground">$2.56/GPU/hr</span> with
            6-month commitment (27% savings)
          </div>
        </div>
      </div>
    </section>
