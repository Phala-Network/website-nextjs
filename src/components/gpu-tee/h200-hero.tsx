        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-24">
          ...
          <div className="flex flex-col items-center justify-center text-center lg:items-start lg:text-left">
            ...
            <div className="flex w-full justify-center overflow-hidden rounded-xl lg:justify-start">
              <img
                src="/gpu-h200.png"
                alt="NVIDIA H200 with Full-Stack TEE"
          ...
          <div className="flex flex-col items-center justify-center text-center lg:items-start lg:text-left">
            <p className="mb-8 max-w-xl text-balance font-display leading-7 text-muted-foreground lg:text-xl">
              From a single GPU to thousands. Industry's largest GPU memory with
              complete Intel TDX + NVIDIA Confidential Computing protection.
              On-demand or reserved pricing.
            </p>

            <div className="mb-8 grid w-full max-w-xl grid-cols-2 gap-4">
              <div className="rounded-lg border bg-card p-5">
                <div className="font-display text-3xl font-bold leading-none">141GB</div>
                <div className="mt-1 font-display text-sm leading-5 text-muted-foreground">HBM3e Memory</div>
              </div>
              <div className="rounded-lg border bg-card p-5">
                <div className="font-display text-3xl font-bold leading-none">4.8 TB/s</div>
                <div className="mt-1 font-display text-sm leading-5 text-muted-foreground">Bandwidth</div>
              </div>
              <div className="rounded-lg border bg-card p-5">
                <div className="font-display text-3xl font-bold leading-none">2x Faster</div>
                <div className="mt-1 font-display text-sm leading-5 text-muted-foreground">vs H100</div>
              </div>
              <div className="rounded-lg border bg-card p-5">
            ...
            <div className="mt-8 text-balance font-display text-sm leading-5 text-muted-foreground lg:text-base lg:leading-6">
              Starting at{' '}
              <span className="font-semibold text-foreground">$3.50/GPU/hr</span>{' '}
              on-demand or{' '}
              <span className="font-semibold text-foreground">$2.56/GPU/hr</span> with
              6-month commitment <span className="text-green-600 dark:text-green-400">(27% savings)</span>
            </div>
          </div>
        </div>
      </div>
