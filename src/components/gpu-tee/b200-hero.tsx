        ...
        <div className="flex flex-col items-center text-center lg:max-w-3xl lg:items-start lg:text-left">
          ...
          <div className="mb-8 grid grid-cols-2 gap-4 w-full max-w-xl">
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">192GB</div>
              <div className="text-sm text-muted-foreground">HBM3e Memory</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">8 TB/s</div>
              <div className="text-sm text-muted-foreground">Bandwidth</div>
            </div>
            <div className="rounded-lg border bg-card p-4">
              <div className="text-2xl font-bold">15x Faster</div>
          ...
          <div className="mt-6 text-sm text-muted-foreground">
            Starting at{' '}
            <span className="font-bold text-foreground">$7.99/GPU/hr</span>{' '}
            on-demand or{' '}
            <span className="font-bold text-foreground">$5.63/GPU/hr</span> with
            6-month commitment (29% savings)
          </div>
        </div>
      </div>
    </section>
