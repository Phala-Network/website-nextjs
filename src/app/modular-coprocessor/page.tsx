    ...
    <div className="flex flex-col gap-8 sm:gap-16">
      ...
      <section className="lg:-mt-60 z-10 lg:px-8 xl:px-32">
        <div className="mx-auto text-center rounded bg-black-800 py-16 w-full max-w-6xl">
          ...
          <p className="mt-2.5 text-black-200 px-4 lg:px-0">
            Modular Coprocessor of blockchains involves data indexing,
            processing and proof.
          </p>
          {pageSettings.videoBlockId ? (
            <Video
              blockId={pageSettings.videoBlockId}
              className="max-w-4xl aspect-896/504 mx-auto mt-12 rounded-sm overflow-hidden"
            />
          ) : null}
        </div>
      </section>
      ...
      <Section theme="dark">
        ...
        <SectionActions>
          ...
          <ContactUsButton className="btn btn-xl btn-primary btn-wht btn-rounded min-w-60 px-0">
            Talk to an expert
          </ContactUsButton>
        </SectionActions>
      </Section>
      ...
      <Section>
        ...
        <SectionBody className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          >
            <img
              src="/illustrations/coprocessor-step-by-step-write.png"
              alt=""
            ...
            <p className="m-4 text-sm">
              Begin your project by leveraging one of our pre-built Oracle
              templates. Eliminating the need for custom coding, enabling a
              quicker and more efficient implementation process.
            </p>
          </div>
          <div
            className={cn(
          ...
          >
            <img
              src="/illustrations/coprocessor-step-by-step-deploy.png"
              alt=""
              className="w-full rounded-sm"
            />
            <h4 className="mt-6 px-4 font-bold text-xl w-full text-left">
            ...
            <p className="m-4 text-sm">
              Use the Command Line Interface (CLI) to deploy and seamlessly
              connect to the Phat Contract dashboard. Simplifying deployment,
          ...
          >
            <img
              src="/illustrations/coprocessor-step-by-step-run.png"
              alt=""
              className="w-full rounded-sm"
            />
            <h4 className="mt-6 px-4 font-bold text-xl w-full text-left">
            ...
            <p className="m-4 text-sm">
              After successfully deploying your Phat Contract Oracle, it
              automatically initiates and runs at regular intervals.
            </p>
          </div>
          <div
            className={cn(
          ...
          >
            <img
              src="/illustrations/coprocessor-step-by-step-execute.png"
              alt=""
              className="w-full rounded-sm"
            />
            <h4 className="mt-6 px-4 font-bold text-xl w-full text-left">
            ...
            <p className="m-4 text-sm">
              Data execution takes place every 10 seconds to ensure continuous
              operation and data flow. Phat Contract will automatically handle
              the request and response flow once initiated.
            </p>
          </div>
        </SectionBody>
      </Section>
