...
import { type Blueprint, blueprints, type Proposal, proposals } from './data'
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(rgba(50, 84, 34, 0.5) 1.5px, rgba(111, 183, 78, 0.5) 1.5px)',
          backgroundSize: '32px 32px',
        }}
      />
      <div className="relative z-10">
        <h1 className={cn('text-2xl lg:text-4xl font-black')}>
          Phat Contract Directory
        </h1>
        <p className={cn('text-lg lg:text-2xl font-normal')}>
      ...
      >
        ...
        <div>
          <a
            ...
            href={cn(
              `https://dashboard.phala.network/projects/new/clone?template=${slug}`,
            )}
            target="_blank"
          >
            Take a tour
...
export default function PhatContractDirectoryPage() {
  return (
    <div className={cn('flex flex-col gap-8 lg:gap-12', 'bg-gray-900')}>
      <PageHeading />
      <Proposals />
      <Blueprints />
    </div>
