...
function TrustedPartnershipCard({
  title,
  url,
  description,
  src,
        ...
        <div className="flex flex-row lg:flex-col gap-6 items-center justify-center py-6">
          ...
          >
            <img
              src={src}
              alt={title}
              className="w-3/5 select-none pointer-events-none"
            />
          </Link>
          <div className="flex flex-col gap-2">
            <h4 className="flex flex-row gap-4 lg:justify-center items-center">
              <Link
                href={post || url}
                target="_blank"
                className="text-white text-[20px] lg:text-[24px] font-bold"
              >
                {title}
              </Link>
...
const items = [
  ...
  },
  {
    ...
    tags: ['Web3 Social', 'DePIN', 'Buiilder'],
  ...
  },
  {
    ...
    tags: ['Web3 Social', 'Tools', 'Builder'],
  ...
  },
  {
    ...
    tags: ['Communications', 'Builder', 'AI'],
  ...
  },
  {
    ...
    description:
      '0G is a leading provider of security solutions for the web3 ecosystem. It offers a range of services, including audit, security research, and advisory services.',
    tags: ['AI', 'Blockchain'],
  },
  {
    name: 'CARV',
...
function LatestNews() {
  ...
  return (
    <section
      className={cn(
        'section--latest-news',
        'px-6 lg:py-14 lg:px-10',
        'mx-auto max-w-[1760px]',
      )}
    >
      <header>
        <h2 className="text-[24px] lg:text-[40px] font-black text-whiteAlpha-800 max-w-5xl mb-4 lg:mb-10 mx-auto text-center">
          Latest News
        </h2>
      </header>
    ...
    <div className="bg-black-900">
      ...
      >
        <header className="row-start-1 col-span-full z-1 flex flex-col justify-center py-4 lg:py-0">
          <h1 className="text-black-800 text-[24px] lg:text-[48px] font-black text-center tracking-wide">
            Phala’s Ecosystem Overview
          </h1>
          <p className="text-black-500 text-[16px] lg:text-[24px] leading-8 text-center lg:mt-4">
            Where AI meets Web3.0
          </p>
        </header>
        <div className={cn('row-start-1 col-span-full z-0 untanglable')}>
          <div className={cn('relative overflow-hidden rounded w-full h-full')}>
            <img
              src="/illustrations/partnerships.jpg"
              alt=""
