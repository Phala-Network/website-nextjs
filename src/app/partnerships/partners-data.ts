...
export const partnersData: PartnerItem[] = [
  {
    ...
    icon: '/partnerships/nvidia-inception.svg',
    description:
      'NVIDIA Inception Program is designed to help startups accelerate innovation and growth.',
    tags: ['AI'],
  },
  {
    name: 'OpenRouter',
    url: 'https://openrouter.ai',
    icon: '/partnerships/open-router.svg',
    description:
  ...
  },
  {
    name: 'OODA',
    url: 'https://ooda.ai/',
    icon: '/partnerships/ooda.svg',
    description:
      'OODA AI is a Nasdaq-listed (Nasdaq First North Growth Market) AI Company with global operations focused on AI Applications, API:s and Agents—offering GDPR-grade data security and decentralized AI computing.',
    tags: ['AI'],
  },
  {
    name: 'PublicAI',
    url: 'https://publicai.io/',
    icon: '/partnerships/public-ai.svg',
    description:
      'PublicAI revolutionizes the AI ecosystem by delivering premium, on-demand AI training data while enabling individuals worldwide to monetize their expertise.',
    tags: ['AI'],
  },
  {
    name: 'Near',
    url: 'https://near.org/',
    icon: '/partnerships/near.svg',
    description:
      'NEAR AI brought by Near foundation is a distributed system for building, deploying, and managing AI agents with the goal of making open source and user-owned AGI.',
    tags: ['AI', 'Blockchain'],
  },
  {
    name: 'Succinct',
    ...
    description:
      'Succinct is dedicated to build the novel ZK technologies, such as SP1, which is a performant, open-source zero-knowledge virtual machine (zkVM)',
    tags: ['ZK'],
  },
  {
    name: 'Vana',
    url: 'https://www.vana.org/',
    icon: '/partnerships/vana.svg',
    description:
  ...
  },
  {
    ...
    icon: '/partnerships/nethermind.svg',
    description:
      'Nethermind is a blockchain infrastructure provider whose vision is to empower enterprises and developers worldwide to access and build on decentralized systems.',
  ...
  },
  {
    ...
    description:
      'Primus uses secure zkTLS (zero-knowledge transport layer security) and zkFHE (zero-knowledge fully homomorphic encryption) to validate arbitrary web data and utilize it in an encrypted form.',
    tags: ['ZK'],
  },
  {
    name: 'Flashbots',
  ...
  },
  {
    ...
    icon: '/partnerships/eliza-os.svg',
    description:
      'Eliza is a pioneering venture capital firm that operates as a decentralized autonomous organization (DAO), leveraging the power of artificial intelligence to revolutionize investment strategies and foster an open-source community around AI agents.',
    tags: ['AI'],
  },
  {
    name: 'Mind Network',
  ...
  },
  {
    ...
    description:
      'GoPlus Security is a leading security layer for web3, protecting every transaction for users and also providing security intelligence for developers to protect their users.',
    tags: ['Security'],
  },
  {
    name: '0G',
    url: 'https://0g.ai/',
    icon: '/partnerships/0g.svg',
    description:
  ...
  },
  {
    ...
    description:
      'CARV is building an AI chain ecosystem to enable data sovereignty at scale. By empowering AI agents with secure, unified infrastructure, CARV enables intelligent, collaborative operations through its SVM Chain, offering trustless consensus, cryptographic proofs, and verifiable execution.',
    tags: ['AI', 'Data'],
  },
  {
    name: 'IO.NET',
  ...
  },
  {
    ...
    description:
      'Hyperbolic unites global compute to provide accessible, affordable, and scalable GPU resources and AI services. Start in seconds, and keep running.',
    tags: ['AI', 'GPU'],
  },
  {
    name: 'xNomadAI',
    ...
    description:
      'xNomadAI is an open-source platform that transforms AI agents into transferable and trackable NFTs. By enabling AI-driven systems to operate independently, xNomadAI provides a foundation for creating intelligent and secure digital assets.',
    tags: ['Agent', 'NFT'],
  },
  {
    name: 'Ava Protocol',
    ...
    description:
      'Ava Protocol is a cutting-edge automation platform designed for the decentralized world. Ava enables users to create event-driven, autonomous "super-transactions" across DeFi and Web3.',
  ...
  },
  {
    ...
    description:
      'Morpheus is designed to incentivize the first peer-to-peer network of personal general-purpose AIs, known as Smart Agents, capable of executing Smart Contracts on behalf of users.',
    tags: ['AI'],
  },
  {
    name: 'Artela',
    ...
    description:
      'Artela is an extensible Layer 1 blockchain with parallel execution and interoperable virtual machines. It pioneers the EVM++ pattern, enabling modular, customizable, and scalable dApps.',
    tags: ['AI', 'Blockchain'],
  },
  {
    name: 'Allora',
  ...
  },
  {
    ...
    description:
      'Pond is building a decentralized Graph Neural Network (GNN) model for Web 3.0. This model is designed to learn on-chain behaviors and predict future behaviors.',
    tags: ['AI'],
  },
  {
    name: 'FLock.io',
    ...
    description:
      "FLock.io seeks to decentralise training and value alignment. They ensure that AI objectives match the public's ethics and societal aims, that decision-making falls to communities, and that usefulness is a top priority.",
    tags: ['AI'],
  },
  {
    name: 'The Graph',
  ...
  },
  {
    ...
    icon: '/partnerships/primus.png',
    description:
      'Primus is a pioneer in cryptographic security, specializing in zkTLS, Fully Homomorphic Encryption (FHE), and the FHE Virtual Machine (FHEVM).',
    tags: ['FHE', 'ZK'],
  },
  {
    name: 'Fairblock',
  ...
  },
  {
    ...
    description:
      'CrunchDAO leverages the collective intelligence of data scientists to develop machine learning models and trading signals that generate profits in varying market conditions.',
    tags: ['AI', 'DAO'],
  },
  {
    name: 'Streamr',
    ...
    description:
      'Streamr is a decentralized network purpose-built for real-time data streaming. It uses a peer-to-peer (P2P) architecture and a publish/subscribe (pub/sub) model, allowing data producers to broadcast streams that applications and nodes can subscribe to and consume instantly.',
    tags: ['Data'],
  },
  {
    name: 'Sentient',
    ...
    description:
      'Sentient Foundation is a non-profit initiative pioneering a new era in AI, aiming to empower communities to build what it calls "Loyal AI" – AI systems that are community-built, community-aligned, and community-owned.',
    tags: ['AI'],
  },
  {
    name: 'Newton',
    ...
    description:
      "Magic Labs' Newton is a platform for agentic automation in crypto, built to simplify user interactions across DeFi and Web3.",
  ...
  },
  {
    ...
    description:
      'Blorm is forming blockchain information. a blorm is an onchain action.',
    tags: ['AI'],
  },
  {
    name: 'Xtrace',
    ...
    description:
      'Building the privacy layer for AI. Memory, search, encryption - all in one SDK.',
    tags: ['AI', 'RAG'],
  },
  {
    name: 'Crossmint',
    ...
    description:
      'Crossmint is an all-in-one platform that simplifies building onchain applications for businesses.',
    tags: ['Financial'],
  },
  {
    name: 'Intel',
    ...
    description:
      'Intel® Trust Domain Extension (Intel® TDX) allows you to deploy hardware-isolated confidential virtual machines (CVMs) called trust domains (TDs).',
    tags: ['CPU'],
  },
  {
    ...
    description:
      'Microsoft offers advanced supercomputing and industry-leading security and privacy, along with access to the latest AI models and developer tools so you can build faster and stay ahead the curve.',
    tags: ['CPU'],
  },
  {
    name: 'NanoGPT',
    ...
    description:
      'Access ChatGPT and all other text and image models. Anonymous, private, pay-per-prompt using Nano, other crypto, or credit cards!',
    tags: ['AI'],
  },
  {
    name: 'Magic Link',
    ...
    description:
      "Magic started in 2018 with a vision to simplify wallets, which at the time were the worst part of going onchain. Users loved our product. Some in the industry said it wouldn't succeed. They were wrong. We invented a multi-billion dollar category.",
    tags: ['Financial'],
  },
  {
    name: 'Rabbi',
