...
export const metadata: Metadata = {
  title: aiAgentContent.seo.title,
  description: aiAgentContent.seo.description,
  keywords: aiAgentContent.seo.keywords,
  openGraph: {
    title: aiAgentContent.seo.title,
    description: aiAgentContent.seo.description,
    type: "website",
...
const WhyItMatters = () => {
  const content = aiAgentContent.why;
  return (
...
const SuccessStories = () => {
  const content = aiAgentContent.stories;
  return (
    <Casestudies3
...
const FinalCTA = () => {
  const content = aiAgentContent.cta;
  return (
    <Cta4
      title={content.title}
