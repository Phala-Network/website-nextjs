...
export const metadata: Metadata = {
  ...
  description: "Deploy AI agents with hardware-enforced security, cryptographic proofs, and verifiable execution. From autonomous trading to personal assistants.",
  keywords: ["AI agents", "verifiable execution", "autonomous agents", "financial agents", "TEE", "ERC-8004", "attestation", "LangChain", "ElizaOS"],
};
