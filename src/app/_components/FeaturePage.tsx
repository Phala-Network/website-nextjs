...
function FeaturePageLeft() {
  return (
    <div className={cn("w-full h-full flex flex-col justify-center items-center gap-5")}>
      <header className={cn("w-full flex-col gap-5 ml-16 hidden xl:flex")}>
      ...
      <main className={cn("w-full hidden xl:grid grid-cols-10 gap-1")}>
        <div className={cn("col-span-10 xl:col-start-2 xl:col-span-9")}>
          <FeatureDetail idx={1} iconUrl="/icons/features-compare.svg" summary="Connect your smart contract anywhere">
            <p>
        ...
        <div className={cn("col-span-10 xl:col-start-2 xl:col-span-9")}>
          <FeatureDetail idx={2} iconUrl="/icons/features-all-out.svg" summary="Seamless access to the Internet">
            <p>
        ...
        <div className={cn("col-span-10 xl:col-start-2 xl:col-span-9")}>
          <FeatureDetail idx={3} iconUrl="/icons/features-auto-graph.svg" summary="Advanced flexibility and performance">
            <p>
        ...
        <div className={cn("col-span-10 xl:col-start-2 xl:col-span-9")}>
          <FeatureDetail idx={4} iconUrl="/icons/features-rocket.svg" summary="Computation is always verifiable">
            <p>
...
export function FeatureMobileHeadPage() {
  return (
    <div
      className={cn([
        "w-screen h-screen flex flex-col pt-32 gap-5 xl:hidden",
      ])}
    >
...
export function FeatureMobileDetailPage({ index, iconUrl, title, content } : {
  index: number,
  iconUrl: string,
  title: string,
  content: string,
  ...
  return (
    <div
      className={cn([
        "w-screen h-screen flex flex-col pt-28 pb-5 gap-5 xl:hidden",
      ])}
    >
      ...
      <header className={cn("flex justify-center items-center px-8")}>
...
export function FeaturePage({ index }: { index: number }) {
  return (
    <section className={cn("w-screen h-screen overflow-hidden")}>
      {/* PC Page */}
      <div className="w-full h-full max-w-[1760px] m-auto hidden xl:block">
...
export function FixedFeaturePage() {
  ...
  return (
    ...
    >
      <section className={cn("hidden xl:block w-screen h-screen overflow-hidden max-w-[1760px] m-auto")}>
