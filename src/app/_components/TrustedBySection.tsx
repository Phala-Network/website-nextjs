...
const imgFrame47689 = "http://localhost:3845/assets/41b332b6707af76794eb7628d18021c13495ef9e.svg";
  ...
  return (
    <section className="w-full flex flex-col gap-16 items-center justify-start py-16">
      <div className="flex flex-col gap-6 items-center w-[854px]">
        <div className="flex flex-row gap-4 items-center text-5xl text-left tracking-[-1.056px] w-full">
        ...
        <div className="font-medium text-[#61645b] text-lg text-center tracking-[-0.306px] w-full">
      ...
      <div className="flex flex-row gap-4 items-center">
        <div className="bg-[#c4f144] flex flex-row gap-2.5 h-12 items-center justify-center px-6 py-[11px] rounded-full w-60">
          <span className="font-semibold text-[#1e2119] text-sm text-center tracking-[-0.084px]">Explore All TEE Apps</span>
        </div>
        <div className="bg-[#1e2119] flex flex-row gap-2.5 h-12 items-center justify-center px-6 py-[11px] rounded-full w-60">
          <span className="font-semibold text-white text-sm text-center tracking-[-0.084px]">Explore Cases</span>
        </div>
      </div>
    </section>
  );
