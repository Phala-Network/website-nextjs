...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path fill="#8C8C8C" d="M92.995 108.799v-15.07L74.6 82.849l18.394 25.95Z" />
    <path fill="#141414" d="m92.994 90.242 18.394-10.886-18.394-8.37v19.256Z" />
    <path fill="#393939" d="m74.6 79.356 18.394 10.886V70.986l-18.393 8.37Z" />
    <defs>
      <filter
        id="a"
        width={186}
