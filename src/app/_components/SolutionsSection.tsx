  ...
  return (
    <section className="w-full flex flex-col items-center py-16 gap-8">
      <div className="flex flex-row items-center justify-between w-full max-w-[1392px] px-6">
        <span className="font-semibold text-[#1e2119] text-[48px] text-left text-nowrap tracking-[-1.056px]">Solutions</span>
        <div className="bg-[#c4f144] flex flex-row gap-2.5 h-12 items-center justify-center px-6 py-[11px] rounded-full w-60">
          <span className="font-semibold text-[#1e2119] text-[14px] text-center tracking-[-0.084px]">View All Products</span>
        </div>
      </div>
      {/* Main Card Row */}
      <div className="flex flex-row gap-6 h-[367px] items-center justify-center w-full max-w-[1392px]">
        ...
        <div className="bg-[#c4f144] h-full overflow-clip rounded-bl-[16px] rounded-br-[80px] rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-[448px] relative flex items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <span className="font-medium text-white text-[32px] text-left text-nowrap tracking-[-0.544px] mt-4">Cloud platform</span>
          </div>
        </div>
        {/* Main Card */}
        <div className="bg-white grow h-full min-h-px min-w-px overflow-clip rounded-2xl shrink-0 relative flex flex-col justify-between">
          <div className="flex flex-col gap-4 items-start px-12 pt-12">
            <span className="font-semibold text-[#1e2119] text-[32px] tracking-[-0.64px]">Phala Cloud</span>
            <span className="font-normal text-[#61645b] text-[16px] text-nowrap tracking-[-0.176px]">All-in-one confidential compute platform for AI workloads</span>
          </div>
          <div className="bg-[#c4f144] flex flex-row items-center justify-between mx-auto my-8 p-2 rounded-full w-[840px]">
            <div className="flex flex-row gap-3.5 items-center px-4 text-[#1a1a1a] text-[20px] text-left tracking-[-0.34px]">
            ...
            <div className="bg-[#0d0d0d] flex flex-row gap-2.5 h-10 items-center justify-center px-6 py-[11px] rounded-full">
              <span className="font-semibold text-white text-[14px] text-center tracking-[-0.084px]">Start Building</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row gap-6 h-[366px] items-center justify-center w-full max-w-[1392px]">
        ...
        <div className="bg-white grow h-full min-h-px min-w-px overflow-clip rounded-2xl shrink-0 relative flex flex-col justify-between">
          <div className="flex flex-col h-[270px] items-start justify-between px-12 pt-12">
            <span className="font-semibold text-[#1a1a1a] text-[32px] text-nowrap tracking-[-0.64px]">Confidential <br />AI Models</span>
            <span className="font-normal text-[#61645b] text-[16px] tracking-[-0.176px] w-60">Pre-configured secure AI models ready to deploy</span>
            <div className="bg-[#0d0d0d] flex flex-row gap-2.5 h-10 items-center justify-center px-6 py-[11px] rounded-full mt-4">
              <span className="font-semibold text-white text-[14px] text-center tracking-[-0.084px]">Browse Models</span>
            </div>
          </div>
        </div>
        {/* Model List Card */}
          ...
          <div className="flex flex-row gap-4 items-center pl-8 pt-8">
            {["Llama-3.1-8B", "GPT-4o-mini", "GPT-4o-mini", "Custmon Model"].map((model, i) => (
              <div key={model + i} className="bg-white h-[302px] overflow-clip rounded-lg w-60 relative flex flex-col justify-between">
                <span className="font-semibold left-6 text-[#1e2119] text-[24px] text-left top-[163px] tracking-[-0.456px] mt-8">{model}</span>
                <div className="flex flex-col gap-2 items-start left-6 top-[232px] text-[#1e2119] text-[16px] text-left tracking-[-0.176px] ml-6 mt-2">
      ...
      <div className="flex flex-row gap-6 h-[367px] items-center justify-center w-full max-w-[1392px]">
        ...
        <div className="bg-[#aabbff] h-full overflow-clip rounded-bl-[16px] rounded-br-[16px] rounded-tl-[80px] rounded-tr-[16px] shrink-0 w-[566px] relative flex items-center justify-center">
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <span className="font-semibold text-white text-[32px] text-left text-nowrap tracking-[-0.544px] mt-4">Free & Open Source</span>
          </div>
        </div>
        {/* Dstack Main Card */}
        <div className="bg-white grow h-full min-h-px min-w-px overflow-clip rounded-2xl shrink-0 relative flex flex-col justify-between">
          <div className="flex flex-col h-[270px] items-start justify-between px-12 pt-12">
            <span className="font-semibold text-[#1a1a1a] text-[32px] text-left tracking-[-0.64px]">Dstack</span>
            <span className="font-normal text-[#61645b] text-[16px] text-left text-nowrap tracking-[-0.176px]">Open-source TEE orchestration framework</span>
            <div className="bg-[#0d0d0d] flex flex-row gap-2.5 h-10 items-center justify-center px-6 py-[11px] rounded-full mt-4">
              <span className="font-semibold text-white text-[14px] text-center tracking-[-0.084px]">Download Framework</span>
            </div>
          </div>
        </div>
      </div>
