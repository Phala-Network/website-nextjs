...
1. Automatically Collected Information
    ...
    - We use third-party tools that track user behavior through cookies: Google Analytics	4 (GA4), PostHog, and Customer.io (for mailing lists).
