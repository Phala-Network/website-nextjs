        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <svg width="150" height="224" viewBox="0 0 150 224" className="scale-[101%]">
              ...
              <path id="path2" fill="none" stroke="#ffffff" strokeWidth="6" d="M 75 0 L 75 224"/>
            </svg>
          </div>
    ...
    <section id="section-pitch-innovate" className="relative z-0">
      <Squircle cornerRadius={48} fill="#d0f964">
        ...
        <div className={cn(
          ...
          <div className={cn(
            "row-start-2 xl:col-start-4 xl:col-span-15 3xl:col-start-6",
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <svg width="472" height="233" viewBox="0 0 472 233" fill="none" className="untanglable h-full aspect-[472/233]">
                      ...
                      <defs>
                      <linearGradient id="paint0_linear_227_213" x1="125.128" y1="116.237" x2="471.999" y2="116.237" gradientUnits="userSpaceOnUse">
                      <stop stop-color="#3D6927"/>
                      <stop offset="1" stop-color="#3D6927" stop-opacity="0"/>
                      </linearGradient>
                      <linearGradient id="paint1_linear_227_213" x1="125.128" y1="116.236" x2="471.999" y2="116.236" gradientUnits="userSpaceOnUse">
                      <stop stop-color="#3D6927"/>
                      <stop offset="1" stop-color="#3D6927" stop-opacity="0"/>
                      </linearGradient>
                      </defs>
      ...
      <div className="relative w-screen overflow-hidden -mb-[2px]">
        <div className={cn(
          ...
          <div className={cn(
            ...
            <svg width="113" height="381" viewBox="0 0 113 381">
              <path fill="none" stroke="#cdfa50" strokeWidth="4" strokeLinecap="round" d="M 2 353.5 L 47 353.5 C 64.673103 353.5 79 341.188873 79 326.002502 L 79 44.582916 C 79 44.582916 79 34.271362 79 44.582916"/>
              <path fill="#cdfa50" stroke="none" d="M 80.999901 40 L 80.999901 32 C 80.999901 14.328491 95.324097 0.002625 112.995003 0 L 44.999901 0 C 62.673 0 76.999901 14.326904 76.999901 32 L 76.999901 40 L 80.999901 40 Z"/>
            </svg>
          </div>
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <svg width="133" height="108" viewBox="0 0 133 108">
              <path id="Path" fill="none" stroke="#323233" strokeWidth="4" strokeLinecap="round" d="M 34 67 L 34 18.910858 C 34 9.571434 48.3269 2.000359 66 2.000359 L 131 2.000366"/>
              <path id="path1" fill="#323233" stroke="none" d="M 35.999901 68 L 35.999901 76 C 35.999901 93.671501 50.3241 107.997002 67.995003 108 L -9e-05 108 C 17.673 108 31.999901 93.673103 31.999901 76 L 31.999901 68 L 35.999901 68 Z"/>
            </svg>
          </div>
      ...
      <div className={cn(
        ...
        <div className={cn("row-start-2 hidden xl:block xl:col-start-3 xl:col-span-14 3xl:col-start-5 3xl:col-span-14 pt-12 -mb-[2px]")}>
          <svg viewBox="0 0 1099 237">
            <path fill="none" stroke="#ffffff" stroke-width="6" d="M 980 60 L 171 60 C 137.397003 60 120.595001 60 107.761002 66.539597 C 96.471001 72.291992 87.292 81.470795 81.539597 92.76059 C 75 105.595001 75 122.397003 75 156 L 75 160"/>
            ...
            <path fill="none" stroke="#ffffff" stroke-width="6" d="M 1096 60 C 1096 91.480225 1070.480225 117 1039 117 C 1007.519775 117 982 91.480225 982 60 C 982 28.519775 1007.519775 3 1039 3 C 1070.480225 3 1096 28.519775 1096 60 Z"/>
