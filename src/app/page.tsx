...
import { SolutionCard, Solutions } from './home_2025/solutions'
...
export const metadata: Metadata = {
  ...
  description:
    'Phala Network make smart contracts even smarter by providing decentralized compute.',
  keywords: [
    'Phala Network',
    'Phala',
    'Phat Contracts',
...
function HeroSection() {
  return (
    <section className="w-screen max-h-screen h-[calc(100vh-3rem)] md:h-screen xl:h-auto xl:aspect-video p-2 relative">
      <div className={cn('mask-teacup', 'flex flex-col justify-center')}>
        <div className="safe-viewport flex flex-col items-center xl:grid xl:grid-cols-12">
          ...
          <header className="xl:flex lg:flex-row gap-2 col-span-10 col-start-2">
            <h1 className="py-1 px-4 text-[24px] md:text-[40px] text-white bg-black rounded-sm font-bold tracking-tight uppercase text-center xl:text-left">
              CRYPTOGRAPHIC COMPUTER
            </h1>
            <h2 className="py-1 text-[24px] md:text-[40px] text-white font-bold tracking-tight text-center xl:text-left">
              Not Tomorrow. Today.
            </h2>
          </header>
          <div className="text-[16px] md:text-[20px] text-white leading-8 my-8 col-span-10 col-start-2 text-center xl:text-left">
          ...
          <div className="flex flex-col md:flex-row gap-4 col-span-10 col-start-2">
            ...
            <Link
              ...
              target="_blank"
              className="btn btn-blk min-w-32 text-center"
            >
              Learn more
            </Link>
          </div>
      ...
      <div className="xl:hidden flex absolute bottom-0 right-0 flex-row items-center justify-center h-24 w-full">
        <span className="text-[24px] p-3 rounded-full bg-white text-black-900 animate-bounce">
          <FiArrowDown />
        </span>
      </div>
      <div className="hidden absolute bottom-0 right-0 w-125 h-32 xl:flex flex-col justify-center items-center">
        <button className="flex flex-row gap-6 items-center">
          <span className="font-bold tracking-tight">
            Learn More About Phala 2.0
          </span>
          <span className="text-[24px] p-3 rounded-full bg-black text-white animate-bounce">
            <FiArrowDown />
          </span>
        </button>
      </div>
  ...
  return (
    <section className="py-12 lg:py-20">
      <main className="safe-viewport grid grid-cols-1 lg:grid-cols-12 gap-y-10">
        <article
          className={cn(
            'lg:col-span-5 xl:col-span-4 xl:col-start-2 lg:row-start-1',
        ...
        >
          ...
          <p className="text-[16px]">
            Trustless systems are expensive. Apps are deployed on either
            centralized clouds you can&apos;t trust or algorithms that are so
            slow and expensive that they&apos;re 1000x the cost.
          </p>
        </article>
        <article
          className={cn(
            'lg:col-span-5 xl:col-span-4 xl:col-start-2 lg:row-start-2',
            'flex flex-col gap-2.5',
          )}
        >
          <h3 className="text-[24px] font-bold tracking-tight mb-1">
          ...
          <p className="text-[16px]">
            The next generation of cloud must be AI-native. Autonomous AI needs
            seamless access to secure physical machines for development,
            deployment, and operation, all while being auditable.
          </p>
        </article>
        <div className="lg:col-span-6 lg:col-start-7 xl:col-span-5 xl:col-start-7 lg:row-start-1 lg:row-span-2 flex flex-row justify-end">
          <figure className="rounded-[0.5rem] rounded-bl-[5.75rem] rounded-tr-[5.75rem] overflow-hidden">
            <picture>
              <source
                srcSet="/home/main-landing-2025/img-problem-1.webp"
                type="image/webp"
              />
              <img
      ...
      <main className="safe-viewport grid grid-cols-1 xl:grid-cols-12">
        <div className="xl:col-span-10 xl:col-start-2">
          <Carousel>
            ...
            >
              <p className="text-gray-600">
                You don&apos;t trust anyone — not clouds, hardware, or us. We
                redefine the security baseline for Web3 with provable, auditable
                TEE that scales.
              </p>
              <ol className="list-disc ml-4 text-gray-600">
                <li>State-of-the-art security enforced by default.</li>
                <li>
                  Perfect for Decentralized AI, blockchain protocol, and
                  anywhere rug pull is not an option.
                </li>
              </ol>
            </CarouselSlide>
          </Carousel>
          ...
          <Solutions>
            ...
            >
              <ul className="space-y-2.5 list-disc ml-4">
                ...
                <li>
                  You deserve the best security with built-in security best
                  practices.
                </li>
              ...
              <div className="flex flex-col md:flex-row gap-4 mt-6">
                <Link
                  ...
                  target="_blank"
                  className="btn btn-blk min-w-36 px-4 py-2 rounded-full text-sm font-medium"
                >
                  Dstack
                </Link>
            ...
            >
              <ul className="space-y-2.5 list-disc ml-4">
                <li>
                  We deal with the pain of hardware maintenance. So you
                  don&apos;t have to.
                </li>
                <li>
                  Get access to CPU and GPU TEEs in one click. Intel TDX, AMD
                  SEV, and nVIDIA H100/H200 available.
                </li>
                <li>
                  With 5 years experience, we know how to deliver the best
                  security.
                </li>
              </ul>
              <div className="flex flex-col md:flex-row gap-4 mt-6">
            ...
            >
              <ul className="space-y-2.5 list-disc ml-4">
                <li>
                  From RA quote to onchain proof, all the evidences are ready
                  for the Pros.
                </li>
                <li>
                  RA Explorer and Phala L2 Explorer tools simplify trustless
                  verification.
                </li>
                <li>
                  Degens can enjoy the security with our user friendly
                  explorers.
                </li>
              </ul>
              <div className="flex flex-col md:flex-row gap-4 mt-6">
                ...
                <Link
                  href="https://phalanetwork.notion.site/TEE-Coprocessor-Handbook-1360317e04a180ffa888f5f6e8a07310"
                  target="_blank"
                  className="btn btn-blk min-w-36 px-4 py-2 rounded-full text-sm font-medium"
                >
                  TEE as a Service
...
function UseCases() {
  return (
    <section className={cn('py-12 lg:py-20 px-2', 'section-usercases')}>
      <main className="safe-viewport flex flex-col lg:grid lg:grid-cols-12 gap-6">
        <h2 className="lg:col-span-12 xl:col-span-10 xl:col-start-2 text-[40px] font-bold tracking-tight text-center mb-6">
        ...
        <div className="lg:col-span-5 xl:col-span-3 xl:col-start-3 rounded p-8 bg-white flex flex-col gap-8 items-center">
          <h4 className="text-[20px] font-semibold tracking-tight mb-1">
            Web2 In. Web3 Out.
          </h4>
          <div className="flex flex-row items-center">
            <div className="h-16 w-16 flex items-center justify-center p-3 border border-black-150 rounded-full">
              <img
                ...
                src="/home/main-landing-2025/icon-x.png"
              />
            </div>
            ...
            <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full">
              <img
                ...
                src="/home/main-landing-2025/icon-openai.png"
              />
            </div>
          </div>
          <p className="text-[14px] text-center text-black-600">
            Turn your web2 apps into verifiable web3 powerhouses in minutes. No
            single points of failure. No headaches. Just connect Docker →
            Blockchain / Autonomous AI. Done.
          </p>
        </div>
        ...
        <div className="lg:col-start-6 lg:col-span-7 xl:col-start-6 xl:col-span-5 rounded p-8 bg-white flex flex-col gap-8 items-center">
                ...
                <div className="flex flex-row w-80">
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white">
                    <img
                      ...
                      src="/home/main-landing-2025/icon-ai-infra1.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-6">
                    <img
                      ...
                      src="/home/main-landing-2025/icon-ai-infra2.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-12">
                    <img
                      className="h-12 w-auto"
                      src="/home/main-landing-2025/icon-ai-infra3.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-18">
                    <img
                      className="h-auto w-12"
                      src="/home/main-landing-2025/icon-ai-infra4.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-24">
                    <img
                      className="h-12 w-auto"
                      src="/home/main-landing-2025/icon-ai-infra5.png"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-row w-64">
                  <div className="h-[62px] w-[62px] flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white">
                    <img
                      ...
                      src="/home/main-landing-2025/icon-ai-agents-2.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-6">
                    <img
                      className="h-8 w-auto"
                      src="/home/main-landing-2025/icon-ai-agents-3.png"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-12">
                    <img
                      className="w-12 h-auto"
                      src="/home/main-landing-2025/icon-ai-agents-aipool.jpg"
                    />
                  </div>
                  <div className="h-16 w-16 flex items-center justify-center border border-black-150 rounded-full overflow-hidden bg-white relative -left-16">
                    <img
                      className="w-auto h-auto"
                      src="/home/main-landing-2025/icon-ai-agents-elizaos.jpg"
                    />
                  </div>
                </div>
              </div>
          ...
          <p className="text-[14px] text-center text-black-600">
            Set your AI free. No AWS. No censorship. Just pure autonomous AI,
            secured by GPU TEE. Train it. Deploy it. Trust it.
            <Link
              href="/reports/2025RealCodeForRealdAGI.pdf"
          ...
          <div className="flex flex-row items-center gap-1 lg:gap-2.5">
            <div className="h-20 w-20 flex items-center justify-center p-3 border border-black-150 rounded-full overflow-hidden">
              <img
                ...
                src="/home/main-landing-2025/icon-lit.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-auto w-16"
                src="/home/main-landing-2025/icon-zama.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-16 w-auto"
                src="/home/main-landing-2025/icon-ss.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-16 w-auto"
                src="/home/main-landing-2025/icon-scroll.png"
              />
            </div>
          </div>
          <p className="text-[14px] text-center text-black-600">
            Secure cryptography even more. Combine TEE with the math kind. No
            flaws. No collusion. Just pure, layered protection.
          </p>
        </div>
        ...
        <div className="lg:col-span-6 lg:col-start-7 xl:col-start-7 xl:col-span-4 rounded p-8 bg-white flex flex-col gap-8 items-center">
          ...
          <div className="flex flex-row items-center gap-1 lg:gap-2.5">
            <div className="h-20 w-20 flex items-center justify-center p-1 border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-auto"
                src="/home/main-landing-2025/icon-flashbots.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-auto w-14 relative -top-0.5"
                src="/home/main-landing-2025/icon-uniswap.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-14 w-auto"
                src="/home/main-landing-2025/icon-ethereum.png"
              />
            </div>
            <div className="h-20 w-20 flex items-center justify-center border border-black-150 rounded-full overflow-hidden">
              <img
                className="h-14 w-auto"
                src="/home/main-landing-2025/icon-polkadot.png"
              />
            </div>
          </div>
          <p className="text-[14px] text-center text-black-600">
            Frontrun the MEV crisis with TEE. Build blocks that can&apos;t be
            censored or sandwiched. Provable execution. Trustless. Fair.
          </p>
        </div>

        <Link
          href="/partnerships"
          className="btn btn-wht rounded-full col-start-3 col-span-8 mt-6"
        >
  ...
  return (
    ...
    >
      <main className="p-10 z-10 text-white min-h-[50%]">
        <h3 className="text-[20px] font-bold tracking-tight mb-4">{title}</h3>
        {children}
      </main>
      <div className="w-6 h-6 rounded-full bg-white absolute top-6 left-6" />
      <div
  ...
  return (
    <section className="py-12 lg:py-20">
      <main className="safe-viewport flex flex-col lg:grid lg:grid-cols-12 gap-10">
        <h2 className="lg:col-span-12 xl:col-span-10 xl:col-start-2 text-[40px] font-bold tracking-tight text-center">
          How It Works
        </h2>
        <div className="lg:col-span-12 xl:col-span-10 xl:col-start-2 flex flex-col lg:grid lg:grid-cols-3 gap-6">
          ...
          >
            <p className="text-[14px] font-medium">
              The TEE hardware ensures your computation is tamper-proof, privacy
              preserving, and unstoppable. It generates the execution proof that
          ...
          >
            <p className="text-[14px] font-medium">
              Phala provides an abstraction unifies the security of Intel SGX,
              Intel TDX, AMD SEV, and NVIDIA GPU TEEs. With decentralized
              Root-of-Trust design benefit from the security of Ethereum.
            </p>
          </HowItWorkCard>
          <HowItWorkCard
          ...
          >
            <p className="text-[14px] font-medium">
              A cryptographic computer is built with not only TEE, but a novel
              blend of TEE, MPC, ZKP, and cryptoeconomic security defends the
              attacks to your app in depth.
            </p>
          </HowItWorkCard>
        </div>
        <div className="md:col-span-10 md:col-start-2 flex flex-row justify-center">
          <a
            href="https://www.paradigm.xyz/2024/11/the-5-levels-of-secure-hardware"
            target="_blank"
            className="btn btn-blk btn-sm rounded-full"
            rel="noopener"
          >
            Explore 5 Levels of Secured Hardwares
          </a>
        </div>
      </main>
    </section>
    ...
    <section className="py-12 lg:py-20">
      <div className="safe-viewport flex flex-col lg:grid lg:grid-cols-12 gap-y-4">
        <header className="lg:col-span-10 lg:row-start-1 lg:col-start-2 text-center">
          <h2 className="text-[40px] font-bold tracking-tight mb-6 text-black-900">
            A Decentralized Cloud
          </h2>
          <p className="text-[20px] font-semibold tracking-tight text-black-600">
        ...
        <figure className="md:col-span-8 md:col-start-3 md: row-start-3 flex flex-col gap-4 items-center">
          <picture>
            <source
              srcSet={`/home/main-landing-2025/img-global-availability.webp`}
              type="image/webp"
            />
            <img
              src={`/home/main-landing-2025/img-global-availability.jpg`}
        ...
        <div className="md:col-span-8 md:col-start-3 md:row-start-3 flex flex-col-reverse w-full h-full items-center">
          <div className="relative top-1">
            <a
              href="https://cloud.phala.network"
              className="btn btn-blk rounded-full"
            >
              Visit Phala Cloud
            </a>
          </div>
    ...
    <section className="py-12 lg:py-20 bg-[hsl(78,32%,95%)]">
      <main className="safe-viewport flex flex-col md:grid md:grid-cols-12 gap-6">
        <header className="md:col-span-12 xl:col-span-10 xl:col-start-2 text-center flex flex-row justify-between items-center">
          ...
          <Link
            href="/blog"
            className="btn btn-blk btn-sm min-w-36 rounded-full tracking-wide"
          >
            More
          </Link>
        </header>
